...
import com.uet.restaurant.Interface.ILoadMore;
import com.uet.restaurant.Model.Order;
...
//        getAllOrder();
    ...
    private void getMaxOrder() {
        ...
        mCompositeDisposable.add(mIRestaurantAPI.getMaxOrder(headers,
    ...
    private void getAllOrder(int from, int to) {
        ...
        HashMap<String, String> headers = new HashMap<>();
        headers.put("Authorization", Common.buildJWT(Common.API_KEY));
        mCompositeDisposable.add(mIRestaurantAPI.getOrder(headers,
