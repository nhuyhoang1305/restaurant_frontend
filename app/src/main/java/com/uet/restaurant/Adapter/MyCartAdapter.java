...
import com.uet.restaurant.Interface.IOnImageViewAdapterClickListener;
import com.uet.restaurant.Model.EventBus.CalculatePriceEvent;
...
public class MyCartAdapter extends RecyclerView.Adapter<MyCartAdapter.MyViewHolder> {
    ...
    public MyCartAdapter(Context mContext, List<CartItem> mCartItem) {
        this.mContext = mContext;
        this.mCartItemList = mCartItem;
